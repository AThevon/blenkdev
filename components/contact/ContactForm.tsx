   ...
   return (
      <div className="max-w-2xl mt-1 w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 md:pb-4 shadow-input bg-neutral-50 dark:bg-neutral-900 border border-black/[0.2] dark:border-white/[0.2]">
         ...
         <form className="my-8" onSubmit={handleSubmit}>
            ...
            <motion.button
               className="relative group/btn bg-neutral-800  block w-[80%] mx-auto text-white rounded-md h-14 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--neutral-800)_inset,0px_-1px_0px_0px_var(--neutral-800)_inset]"
               type="submit"
