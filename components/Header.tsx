        ...
        <header className="absolute top-0 left-0 flex items-center justify-between w-full">
            <div className="w-full flex items-center justify-between px-8 py-4">
                <motion.div className="flex items-center justify-center select-none"
                    ...
                    animate={{ opacity: 1, x: 0, scale: 1, transition: { delay: 0.7, duration: .3 } }}
                    transition={{ type: "spring", damping: 17, stiffness: 400, mass: 0.6 }}
                >
                    <motion.div
                        className="w-24 h-24 z-10"
                        initial={{ rotate: 0 }}
                        animate={{ rotate: 360, transition: { delay: 1, duration: .35 } }}
